...
- [-] 4. Checkpoint — Verify auth and role fixes
...
- [x] 5. Artist profile completion fixes
  ...
  - [x] 5.2 Verify `GET /api/artists/profile/status` in `server/routes.ts`
    ...
    - _Requirements: 2.3_
  - [ ] 5.3 Write property tests for artist profile completion
...
- [ ] 7. Checkpoint — Verify profile fixes
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 8. Conversation system — participant resolution
  - [ ] 8.1 Fix conversation open endpoint in `server/routes/conversations.ts`
  ...
  - [ ] 8.2 Fix conversation idempotency and workflow initialization
...
- [ ] 9. Negotiation workflow state machine fixes
  - [ ] 9.1 Fix `handleAction` in `server/services/workflow.ts`
...
- [ ] 10. Message display and negotiation mode enforcement
  - [ ] 10.1 Fix message ordering and access control in `server/routes/conversations.ts`
...
- [ ] 11. Checkpoint — Verify conversation and workflow fixes
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 12. Contract initiation fixes
  - [ ] 12.1 Verify contract initiation endpoint in `server/routes/contracts.ts`
...
- [ ] 13. Contract review and edit workflow fixes
  - [ ] 13.1 Verify contract review endpoint in `server/routes/contracts.ts`
  ...
  - [ ] 13.2 Verify edit response endpoint in `server/routes/contracts.ts`
  ...
  - [ ] 13.3 Verify contract validation logic in `server/routes/contracts.ts`
...
- [ ] 14. Contract acceptance and signing fixes
  - [ ] 14.1 Verify contract accept and sign endpoints in `server/routes/contracts.ts`
...
- [ ] 15. Contract deadline enforcement fixes
  - [ ] 15.1 Verify deadline enforcement endpoint in `server/routes/contracts.ts`
...
- [ ] 16. Final checkpoint — Verify all fixes
  - Ensure all tests pass, ask the user if questions arise.
