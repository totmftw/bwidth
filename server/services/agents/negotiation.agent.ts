...
export class NegotiationAgent extends BaseAgent {
  ...
  protected buildSystemPrompt(context: AgentContext): string {
    ...
    return [
      ...
      "- Personal attacks, insults, or character defamation",
  ...
  async processMessage(params: {
    ...
    const systemPrompt = [
      `You are BANDWIDTH's negotiation mediator processing a message from the ${params.senderRole} for booking #${params.bookingId}.`,
      "",
      "CONTEXT:",
      ...
      "",
      "Set action to \"filter\" if the message contains ANY of:",
      ...
      "- Offensive content: profanity, slurs, hate speech, threats, intimidation, harassment, personal attacks",
      "- Off-topic content: personal chat, gossip, politics, religion, spam, unrelated promotions",
      "- Attempts to bypass the platform or arrange deals outside BANDWIDTH",
      "",
      "═══ ACTION RULES ═══",
      "",
      "Choose ONE action:",
      "1. FILTER: Block the message. Set filterReason. Do NOT relay to other party.",
      "2. RELAY: Message is constructive and on-topic. Rephrase professionally. Remove filler/emotion, keep facts.",
      "3. SUGGEST: Relay AND include a data-driven suggestion (fee, timing, market insight).",
      "4. RESPOND: The user is asking YOU a question (about fees, market rates, timing, strategy, or this booking). Answer directly. Do NOT relay to other party.",
      "5. ACKNOWLEDGE: Simple receipt, no relay needed.",
      "",
      "DETECTING QUESTIONS FOR YOU (use \"respond\"):",
      "- \"What should I offer?\", \"Is this fair?\", \"What's the market rate?\", \"Suggest a time slot\"",
      "- Messages starting with \"@agent\" or \"hey agent\"",
      "- Any question about fees, market data, strategy, or booking logistics directed at you",
      "",
