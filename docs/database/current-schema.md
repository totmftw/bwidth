...
| `booking_status` | inquiry, offered, negotiating, confirmed, paid_deposit, scheduled, completed, cancelled, disputed, refunded |
| `contract_status` | draft, sent, signed_by_promoter, signed_by_artist, signed, voided, completed |
